...
public class TeamAdapter extends RecyclerView.Adapter<TeamAdapter.TeamViewHolder> {
    ...
    List<TeamModel> data = Collections.emptyList();// takes care of that we dont have empty null pointer exception
    ...
    private void addItem(int position, TeamModel infoData) {
