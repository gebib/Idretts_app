...
public class PlayerAdapter extends RecyclerView.Adapter<PlayerAdapter.PlayerViewHolder> {
    ...
    List<PlayerDummyData> data = Collections.emptyList();// takes care of that we dont have empty null pointer exception
    private LayoutInflater inflater;
    private int previousPosition = 0;


    public PlayerAdapter(Context context, List<PlayerDummyData> data) {
    ...
    public void onBindViewHolder(PlayerViewHolder playerViewholder, final int position) {
        ...
        final PlayerDummyData ddata = data.get(position);
    ...
    private void addItem(int position, PlayerDummyData infoData) {
    ...
    private void removeItem(PlayerDummyData infoData) {
