...
public class Home extends AppActivity {
    ...
    /**
     * A placeholder fragment containing a simple view. ///////////////////////frag manag//////////////////////*/
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)){
                case 1:
                    rootView = inflater.inflate(R.layout.fragment_trainer, container, false);
                    break;
                case 2:
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getString(R.string.trainerTabName);
                case 1:
                    return getString(R.string.playerTabName);
                case 2:
                    return getString(R.string.teamTabName);
            }
            return null;
        }
    }
