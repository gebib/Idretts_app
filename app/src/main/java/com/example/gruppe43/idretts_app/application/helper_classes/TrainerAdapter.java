...
public class TrainerAdapter extends RecyclerView.Adapter<TrainerAdapter.TrainerViewHolder> {
    ...
    List<TrainerModel> data = Collections.emptyList();// takes care of that we dont have empty null pointer exception
    private LayoutInflater inflater;
    private int previousPosition = 0;


    public TrainerAdapter(Context context, List<TrainerModel> data) {
    ...
    public void onBindViewHolder(TrainerViewHolder trainerViewholder, final int position) {
        ...
        final TrainerModel ddata = data.get(position);
    ...
    private void addItem(int position, TrainerModel infoData) {
    ...
    private void removeItem(TrainerModel infoData) {
